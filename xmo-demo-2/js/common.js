...
$(function(){
      ...
      $('body').on('click','.x-user-main',function(){
        if($(this).find(".x-user-list").css("visibility")=="hidden"){
          $(".x-user-main").find(".x-user-list").css("visibility","visiable");
            $(".x-user-main").find(".x-user-list").css("opacity","1");
        }else{
